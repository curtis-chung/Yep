...
class ReviewForm(FlaskForm):
    review_content = StringField(
        "review_content", validators=[DataRequired('To submit your review, please explain your ratings to others.'), Length(min=1, max=2000, message='Review must be between 1 and 2000 characters.')])
    stars = IntegerField(
